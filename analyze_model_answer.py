...
def analyze_performanece_for_tasks(file_name: str, target: str):
    ...
    output_path = os.path.join(path.model_ans_path, path.task_perf_path, output_sub_dir, f"{target}-{file_name}.csv")
...
if __name__ == "__main__":
    ...
    # base llama with stats prompt: 1-shot+DK
    ...
    ## D-train sweep
    # sft llama zero-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_1_6_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_1_6_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_1_6_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_2_8_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_2_8_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_2_8_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_8_9_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_8_9_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_8_9_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_16_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_16_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_16_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_28_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_28_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_28_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_50_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_50_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_50_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_89_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_89_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_89_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_160_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_280_zero-shot')


    ## StatEval sweep
    # 0.5
    # stateval llama Few-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_0_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_0_5_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_0_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_0_5_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_0_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_0_5_one-shot')
    
    # stateval llama CoT
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_0_5_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_0_5_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_0_5_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_0_5_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_0_5_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_0_5_one-shot-CoT')

    # stateval llama with stats prompt: 1-shot+DK
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_0_5_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_0_5_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_0_5_stats-prompt')

    # 1.5
    # stateval llama Few-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_1_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_1_5_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_1_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_1_5_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_1_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_1_5_one-shot')
    
    # stateval llama CoT
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_1_5_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_1_5_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_1_5_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_1_5_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_1_5_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_1_5_one-shot-CoT')

    # stateval llama with stats prompt: 1-shot+DK
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_1_5_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_1_5_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_1_5_stats-prompt')


    # 5.0
    # stateval llama Few-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_5_0_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_5_0_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_5_0_one-shot')
    
    # stateval llama CoT
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_5_0_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_5_0_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_5_0_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_5_0_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_5_0_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_5_0_one-shot-CoT')

    # stateval llama with stats prompt: 1-shot+DK
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_5_0_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_5_0_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_5_0_stats-prompt')


    # 15
    # stateval llama Few-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_15_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_15_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_15_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_15_one-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_15_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_15_one-shot')
    
    # stateval llama CoT
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_15_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_15_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_15_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_15_one-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_15_zero-shot-CoT')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_15_one-shot-CoT')

    # stateval llama with stats prompt: 1-shot+DK
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_15_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_15_stats-prompt')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_15_stats-prompt')


    ## D-train -> StatEval sweep
    # 0.5
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_stateval_0_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_stateval_0_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_stateval_0_5_zero-shot')

    # 1.5
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_stateval_1_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_stateval_1_5_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_stateval_1_5_zero-shot')

    # 5.0
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_stateval_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_stateval_5_0_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_stateval_5_0_zero-shot')

    # 15
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_stateval_15_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_stateval_15_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_stateval_15_zero-shot')


    ## StatEval -> D-train
    # zero-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_stateval_sft_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_stateval_sft_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_stateval_sft_zero-shot')
    

    ## D-train sft + logic
    # zero-shot
    model_answer_integrate_analysis(answer_file_name='llama2_7b_sft_logic_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_sft_logic_zero-shot')
    model_answer_integrate_analysis(answer_file_name='llama3_8b_instruct_sft_logic_zero-shot')
