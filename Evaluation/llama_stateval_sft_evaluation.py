...
def llama_answer_generation(model_type: str, dataset_name: str, output_name: str, trick: str):
    ...
    # Path settings
    if model_type == '2_7b_stateval_sft':
        model_path = "Models/StatEval_sft/Llama-2-7b-chat-hf-stateval-sft-89"
        parallel_num = 1
    elif model_type == '3_8b_instruct_stateval_sft':
        model_path = "Models/StatEval_sft/Meta-Llama-3-8b-Instruct-stateval-sft-28"
        parallel_num = 1
    elif model_type == '3_8b_stateval_sft':
        model_path = "Models/StatEval_sft/Meta-Llama-3-8b-stateval-sft-28"
        parallel_num = 1
    else:
        raise ValueError("[!] Invalid model type. Please choose from: 2_7b_stateval_sft, 3_8b_instruct_stateval_sft and 3_8b_stateval_sft")
