...
def llama_answer_generation(model_type: str, dataset_name: str, output_name: str, trick: str):
    ...
    # Path settings
    if model_type == '2_7b_stateval_0_5':
        model_path = "Models/StatEval/Llama-2-7b-chat-hf-stateval-0_5"
        parallel_num = 1
    elif model_type == '3_8b_instruct_stateval_0_5':
        model_path = "Models/StatEval/Meta-Llama-3-8b-Instruct-stateval-0_5"
        parallel_num = 1
    elif model_type == '3_8b_stateval_0_5':
        model_path = "Models/StatEval/Meta-Llama-3-8b-stateval-0_5"
        parallel_num = 1
    elif model_type == '2_7b_stateval_1_5':
        model_path = "Models/StatEval/Llama-2-7b-chat-hf-stateval-1_5"
        parallel_num = 1
    elif model_type == '3_8b_instruct_stateval_1_5':
        model_path = "Models/StatEval/Meta-Llama-3-8b-Instruct-stateval-1_5"
        parallel_num = 1
    elif model_type == '3_8b_stateval_1_5':
        model_path = "Models/StatEval/Meta-Llama-3-8b-stateval-1_5"
        parallel_num = 1
    elif model_type == '2_7b_stateval_5_0':
        model_path = "Models/StatEval/Llama-2-7b-chat-hf-stateval-5_0"
        parallel_num = 1
    elif model_type == '3_8b_instruct_stateval_5_0':
        model_path = "Models/StatEval/Meta-Llama-3-8b-Instruct-stateval-5_0"
        parallel_num = 1
    elif model_type == '3_8b_stateval_5_0':
        model_path = "Models/StatEval/Meta-Llama-3-8b-stateval-5_0"
        parallel_num = 1
    elif model_type == '2_7b_stateval_15':
        model_path = "Models/StatEval/Llama-2-7b-chat-hf-stateval-15"
        parallel_num = 1
    elif model_type == '3_8b_instruct_stateval_15':
        model_path = "Models/StatEval/Meta-Llama-3-8b-Instruct-stateval-15"
        parallel_num = 1
    elif model_type == '3_8b_stateval_15':
        model_path = "Models/StatEval/Meta-Llama-3-8b-stateval-15"
        parallel_num = 1
    else:
