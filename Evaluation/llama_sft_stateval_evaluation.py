...
def llama_answer_generation(model_type: str, dataset_name: str, output_name: str, trick: str):
    ...
    # Path settings
    if model_type == '2_7b_sft_stateval_0_5':
        model_path = "Models/sft_StatEval/Llama-2-7b-chat-hf-sft-stateval-0_5"
        parallel_num = 1
    elif model_type == '3_8b_instruct_sft_stateval_0_5':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-Instruct-sft-stateval-0_5"
        parallel_num = 1
    elif model_type == '3_8b_sft_stateval_0_5':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-sft-stateval-0_5"
        parallel_num = 1
    elif model_type == '2_7b_sft_stateval_1_5':
        model_path = "Models/sft_StatEval/Llama-2-7b-chat-hf-sft-stateval-1_5"
        parallel_num = 1
    elif model_type == '3_8b_instruct_sft_stateval_1_5':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-Instruct-sft-stateval-1_5"
        parallel_num = 1
    elif model_type == '3_8b_sft_stateval_1_5':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-sft-stateval-1_5"
        parallel_num = 1
    elif model_type == '2_7b_sft_stateval_5_0':
        model_path = "Models/sft_StatEval/Llama-2-7b-chat-hf-sft-stateval-5_0"
        parallel_num = 1
    elif model_type == '3_8b_instruct_sft_stateval_5_0':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-Instruct-sft-stateval-5_0"
        parallel_num = 1
    elif model_type == '3_8b_sft_stateval_5_0':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-sft-stateval-5_0"
        parallel_num = 1
    elif model_type == '2_7b_sft_stateval_15':
        model_path = "Models/sft_StatEval/Llama-2-7b-chat-hf-sft-stateval-15"
        parallel_num = 1
    elif model_type == '3_8b_instruct_sft_stateval_15':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-Instruct-sft-stateval-15"
        parallel_num = 1
    elif model_type == '3_8b_sft_stateval_15':
        model_path = "Models/sft_StatEval/Meta-Llama-3-8b-sft-stateval-15"
        parallel_num = 1
    else:
    ...
    llm = LLM(
        ...
        # enforce_eager=True,
        tokenizer_mode="slow",  # <-- Force slow tokenizer
